...
do
  ...
  require('gitsigns').setup {
    signs = {
      ...
      topdelete = { text = 'ΓÇ╛' }, ---@diagnostic disable-line: missing-fields
...
do
  ...
  vim.keymap.set({ 'n', 'v' }, '<leader>f', function() require('conform').format { async = false } end, { desc = '[F]ormat buffer' })
end
...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'go', 'gomod', 'gosum', 'php', 'typescript', 'javascript', 'python', 'css', 'scss' }
...
do
  ...
  --
  --  The following line auto-loads all custom plugins in that directory.
